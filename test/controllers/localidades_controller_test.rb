...
class LocalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidade" do
    assert_difference('Localidade.count') do
      post localidades_url, params: { localidade: { cidade_id: @localidade.cidade_id, lat: @localidade.lat, long: @localidade.long, nome: @localidade.nome } }
    end
  ...
  test "should update localidade" do
    patch localidade_url(@localidade), params: { localidade: { cidade_id: @localidade.cidade_id, lat: @localidade.lat, long: @localidade.long, nome: @localidade.nome } }
